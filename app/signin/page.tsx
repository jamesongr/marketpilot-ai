    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.12),_transparent_35%),_radial-gradient(circle_at_bottom_right,_rgba(236,72,153,0.14),_transparent_32%),_linear-gradient(180deg,_#020617_0%,_#020617_100%)] px-6 py-16 text-slate-100 sm:px-10">
      <div className="mx-auto max-w-md rounded-[2rem] border border-slate-800 bg-slate-950/90 p-8 shadow-glow">
        ...
        <div className="mt-8 space-y-5">
          <button type="button" onClick={handleGoogleSignIn} className="flex w-full items-center justify-center gap-3 rounded-full bg-white px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-slate-100">
          ...
          <p className="text-center text-sm text-slate-500">Google manages account creation and login securely. No password needed here.</p>
        ...
        <div className="mt-6 text-center text-sm text-slate-500">
          <Link href="/signup" className="text-sky-300 hover:text-sky-200">Create account with Google</Link>
        </div>
      </div>
    </main>
  );
